       ...
       mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [
           Container(
             height: 80,
            width: 200,
             child: Text("Date d'hospitaliosation", 
         style: TextStyle(
          color: Colors.black,
          fontWeight: FontWeight.bold,
       ...
       mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [
           Container(
             height: 80,
            width: 200,
             child: Text('Nom du parent (gardien) du patient', 
         style: TextStyle(
          color: Colors.black,
          fontWeight: FontWeight.bold,
       ...
       mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [
           Container(
             height: 80,
            width: 200,
             child: Text('Phone du parent (gardien) du patient', 
         style: TextStyle(
          color: Colors.black,
          fontWeight: FontWeight.bold,
      ...
      child: Row(
        ...
        children: [
           Container(
             height: 80,
            width: 200,
             child: Text('Sans argent liquide', 
         style: TextStyle(
          color: Colors.black,
          fontWeight: FontWeight.bold,
       ...
       mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [
           Container(
             height: 80,
            width: 200,
             child: Text('Exemption de facture', 
         style: TextStyle(
          color: Colors.black,
          fontWeight: FontWeight.bold,
