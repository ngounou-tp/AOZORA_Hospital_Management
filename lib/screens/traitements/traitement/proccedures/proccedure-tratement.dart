...
import 'package:admin/screens/traitements/traitement/proccedures/proccedure-create.dart';
...
import '../../../sante-infirmier/proccedure-patient.dart';

class ProccedureTraitement extends StatefulWidget {
  const ProccedureTraitement({Key? key}) : super(key: key);

  @override
  State<ProccedureTraitement> createState() => _ProccedureTraitementState();
}

class _ProccedureTraitementState extends State<ProccedureTraitement> {
  @override
