...
import 'formdocreferent.dart';

int indexbutton = 1;
//int indexmenu = 1;
bool isChecked = false;

class Docteurreferent extends StatefulWidget {
  const Docteurreferent({Key? key}) : super(key: key);

  @override
  State<Docteurreferent> createState() => _Docteurreferent();
}

class _Docteurreferent extends State<Docteurreferent> {
  @override
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Formulairedocreferent()),
                    );
                  },
                  child: Text('CREER'),
                ),
