...
class Creerdiplome extends StatefulWidget {
  const Creerdiplome({Key? key}) : super(key: key);

  @override
  State<Creerdiplome> createState() => _Creerdiplome();
}

class _Creerdiplome extends State<Creerdiplome> {
  @override
            ...
            children: [
              ...
              TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Diplomedocteur()),
                    );
                  },
                  child: Text(
                    'diplome du docteur',
