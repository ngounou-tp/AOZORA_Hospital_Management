...
class ProccedurePatient extends StatefulWidget {
  const ProccedurePatient({Key? key}) : super(key: key);

  @override
  State<ProccedurePatient> createState() => _ProccedurePatientState();
}

class _ProccedurePatientState extends State<ProccedurePatient> {
  @override
